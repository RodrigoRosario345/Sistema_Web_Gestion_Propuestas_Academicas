        ...
        <div class="detalles_documento">
            ...
            <div class="details_carrera_cu">
                ...
                <div class="input-box-documento" style="width: 48%;">
                    ...
                    <input type="text" name="especialidad" class="form-control @error('especialidad') is-invalid @enderror" value="{{ old('especialidad') }}" id="especialidad" placeholder="Especialidad" required>
